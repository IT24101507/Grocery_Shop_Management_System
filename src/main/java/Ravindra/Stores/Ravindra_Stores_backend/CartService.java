...
public class CartService {
    ...
    public void addToCart(Long userId, Long productId, int quantity) {
        ...
        if (existingItem.isPresent()) {
            ...
            BigDecimal priceAtTime = product.getSalePrice() != null ? product.getSalePrice() : BigDecimal.valueOf(product.getPrice());
    ...
    public CartDto getCart(Long userId) {
        ...
        for (CartItem cartItem : cart.getItems()) {
            ...
            BigDecimal currentPrice = product.getSalePrice() != null ? product.getSalePrice() : BigDecimal.valueOf(product.getPrice());
