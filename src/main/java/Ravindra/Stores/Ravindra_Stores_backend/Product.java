...
public class Product {
    ...
    public java.math.BigDecimal getSalePrice() {
        if (discount > 0) {
            ...
            return java.math.BigDecimal.valueOf(discountedPrice);
        }
    ...
    // Convert image data to URL or base64 string for frontend
    public String getImageUrl() {
        if (imageData != null && imageData.length > 0) {
            return "data:image/jpeg;base64," + java.util.Base64.getEncoder().encodeToString(imageData);
        }
        return null;
    }
}
